...
autodoc_type_aliases = {
    ...
    'DTypeLike': 'numpy.DTypeLike',
    'PolyLike': 'numpoly.PolyLike',
}
...
latex_documents = [
    (master_doc, 'NumPoly.tex', 'NumPoly Documentation',
...
man_pages = [
    (master_doc, 'numpoly', 'NumPoly Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NumPoly', 'NumPoly Documentation',
     author, 'NumPoly', 'One line description of project.',
     'Miscellaneous'),
]
